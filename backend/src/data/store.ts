...
const dealStatusChanges: DealStatusChange[] = [
...
export const db = { users, clients, deals, dealStatusChanges, activities, tasks }
...
export function canView(viewerRole: string, viewerId: string, targetManagerId: string): boolean {
  if (viewerRole === 'admin' || viewerRole === 'supervisor') return true
  return viewerId === targetManagerId
}
