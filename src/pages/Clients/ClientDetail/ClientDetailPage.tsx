...
import { MOCK_CLIENTS, MOCK_ACTIVITIES, MOCK_DEALS, MOCK_TASKS } from '@/mocks'
...
export default function ClientDetailPage() {
  ...
  const clientDeals = MOCK_DEALS.filter((d) => d.clientId === id)
  const clientTasks = MOCK_TASKS.filter((t) => t.clientId === id)
